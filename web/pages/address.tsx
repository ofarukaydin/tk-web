...
const AddressPage = (): JSX.Element => {
  ...
  const userAddress = data?.getApiV1AuthenticationGetcurrentuseraddress?.response;
        ...
        {({ values }) => (
          <Form>
            ...
            <Address
              ...
              geolocation={[
                Number.parseInt(userAddress?.latitude || '', 10),
                Number.parseInt(userAddress?.longitude || '', 10),
              ]}
            />
            ...
            <div tw="flex w-full">
              ...
              >
                <InputField name="payment" label="Kapıda Ödeme" type="radio" value="kapi" />
                <p tw="ml-8 text-gray-400">Kapıda nakit veya kredi/banka kartıyla ödeme.</p>
              </div>
              ...
              >
                <InputField name="payment" label="Online Ödeme" type="radio" value="online" />
                <p tw="ml-8 text-gray-400">Online kredi/banka kartı ile ödeme</p>
              </div>
            </div>
            ...
            <div tw="text-right my-8">
              <InputField
                ...
                label={
                  <>
                    ...
                    <a tw="text-green-600">Ön Bilgilendirme Formu</a>’nu okudum ve kabul ediyorum.
                  </>
                }
                type="checkbox"
                rightAlign
              ...
              <div tw="flex justify-end items-center text-gray-500">
                ...
                <button tw="m-6 bg-green-500 text-white rounded w-full py-2 w-64" type="submit">
                  Siparişi Tamamla
                </button>
              </div>
            </div>
